...
def sse_fixture(name):
    ...
    Committed rather than captured at generation time: the assistant runs on Gemini's free
    tier (20 requests/day) and regenerating the collection must not spend that quota.
    """
...
def main():
    ...
    collection = {
        ...
        "item": [
            ...
            {"name": "8. Destructive (run last)", "item": [
